 ...
 * might want to apply to a customer. Coupons may be applied to <a href="https://expressplatby.cz/docs/api#subscriptions">subscriptions</a>, <a href="https://expressplatby.cz/docs/api#invoices">invoices</a>,
 * <a href="https://expressplatby.cz/docs/api/checkout/sessions">checkout sessions</a>, <a href="https://expressplatby.cz/docs/api#quotes">quotes</a>, and more. Coupons do not work with conventional one-off <a href="https://expressplatby.cz/docs/api#create_charge">charges</a> or <a href="https://expressplatby.cz/docs/api/payment_intents">payment intents</a>.
 *
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $applies_to
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency If <code>amount_off</code> has been set, the three-letter <a href="https://expressplatby.cz/docs/currencies">ISO code for the currency</a> of the amount to take off.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $currency_options Coupons defined in each available currency option. Each key must be a three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="https://expressplatby.cz/docs/currencies">supported currency</a>.
