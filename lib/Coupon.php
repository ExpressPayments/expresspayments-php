 ...
 * might want to apply to a customer. Coupons may be applied to <a href="https://docs.epayments.network/api#subscriptions">subscriptions</a>, <a href="https://docs.epayments.network/api#invoices">invoices</a>,
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $applies_to
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency If <code>amount_off</code> has been set, the three-letter <a href="https://docs.epayments.network/currencies">ISO code for the currency</a> of the amount to take off.
 * @property null|\ExpressPayments\ExpressPaymentsObject $currency_options Coupons defined in each available currency option. Each key must be a three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="https://docs.epayments.network/currencies">supported currency</a>.
