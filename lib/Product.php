 ...
 * They can be used in conjunction with <a href="https://docs.epayments.network/api#prices">Prices</a> to configure pricing in Payment Links, Checkout, and Subscriptions.
 *
 * Related guides: <a href="https://docs.epayments.network/billing/subscriptions/set-up-subscription">Set up a subscription</a>,
 * <a href="https://docs.epayments.network/payment-links">share a Payment Link</a>,
 * <a href="https://docs.epayments.network/payments/accept-a-payment#create-product-prices-upfront">accept payments with Checkout</a>,
 * and more about <a href="https://docs.epayments.network/products-prices/overview">Products and Prices</a>
 *
 ...
 * @property null|string|\ExpressPayments\Price $default_price The ID of the <a href="https://docs.epayments.network/api/prices">Price</a> object that is the default price for this product.
 ...
 * @property \ExpressPayments\ExpressPaymentsObject[] $features A list of up to 15 features for this product. These are displayed in <a href="https://docs.epayments.network/payments/checkout/pricing-table">pricing tables</a>.
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $package_dimensions The dimensions of this product for shipping purposes.
 ...
 * @property null|string|\ExpressPayments\TaxCode $tax_code A <a href="https://docs.epayments.network/tax/tax-categories">tax code</a> ID.
...
class Product extends ApiResource
{
     ...
     *
     * @return \ExpressPayments\SearchResult<\ExpressPayments\Product> the product search results
