...
/**
 * A <code>Transfer</code> object is created when you move funds between ExpressPlatby accounts as
 * part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a
 * ExpressPlatby account to a card or bank account. This behavior has since been split
 * out into a <a href="https://expressplatby.cz/docs/api#payout_object">Payout</a> object, with corresponding payout endpoints. For more
 * information, read about the
 * <a href="https://expressplatby.cz/docs/transfer-payout-split">transfer/payout split</a>.
 *
 * Related guide: <a href="https://expressplatby.cz/docs/connect/separate-charges-and-transfers">Creating separate charges and transfers</a>
 *
 ...
 * @property null|string|\ExpressPlatby\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\ExpressPlatby\Account $destination ID of the ExpressPlatby account the transfer was sent to.
 * @property null|string|\ExpressPlatby\Charge $destination_payment If the destination is a ExpressPlatby account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \ExpressPlatby\Collection<\ExpressPlatby\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\ExpressPlatby\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \ExpressPlatby\Collection<\ExpressPlatby\TransferReversal> the list of transfer reversals
