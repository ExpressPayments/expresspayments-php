...
class TopupService extends \ExpressPlatby\Service\AbstractService
{
    /**
     ...
     *
     * @return \ExpressPlatby\Collection<\ExpressPlatby\Topup>
     ...
     * unique top-up ID that was returned from your previous request, and ExpressPlatby will
