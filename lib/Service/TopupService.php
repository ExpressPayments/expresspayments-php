...
class TopupService extends \ExpressPayments\Service\AbstractService
{
    /**
     ...
     *
     * @return \ExpressPayments\Collection<\ExpressPayments\Topup>
     ...
     * unique top-up ID that was returned from your previous request, and ExpressPayments will
