...
class PaymentMethodDomainService extends \ExpressPayments\Service\AbstractService
{
    /**
     ...
     *
     * @return \ExpressPayments\Collection<\ExpressPayments\PaymentMethodDomain>
     ...
     * @param null|array|\ExpressPayments\Util\RequestOptions $opts
     *
     * @return \ExpressPayments\PaymentMethodDomain
     * @throws \ExpressPayments\Exception\ApiErrorException if the request fails
     *
     */
