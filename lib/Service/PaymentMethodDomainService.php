...
class PaymentMethodDomainService extends \ExpressPlatby\Service\AbstractService
{
    /**
     ...
     *
     * @return \ExpressPlatby\Collection<\ExpressPlatby\PaymentMethodDomain>
     ...
     * @param null|array|\ExpressPlatby\Util\RequestOptions $opts
     *
     * @return \ExpressPlatby\PaymentMethodDomain
     *@throws \ExpressPlatby\Exception\ApiErrorException if the request fails
     *
     */
