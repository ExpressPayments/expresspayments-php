 ...
 *
 * Related guide: <a href="https://docs.epayments.network/reports/balance-transaction-types">Balance transaction types</a>
 *
 ...
 * @property int $available_on The date that the transaction's net funds become available in the ExpressPayments balance.
 ...
 * @property null|float $exchange_rate If applicable, this transaction uses an exchange rate. If money converts from currency A to currency B, then the <code>amount</code> in currency A, multiplied by the <code>exchange_rate</code>, equals the <code>amount</code> in currency B. For example, if you charge a customer 10.00 EUR, the PaymentIntent's <code>amount</code> is <code>1000</code> and <code>currency</code> is <code>eur</code>. If this converts to 12.34 USD in your ExpressPayments account, the BalanceTransaction's <code>amount</code> is <code>1234</code>, its <code>currency</code> is <code>usd</code>, and the <code>exchange_rate</code> is <code>1.234</code>.
 ...
 * @property \ExpressPayments\ExpressPaymentsObject[] $fee_details Detailed breakdown of fees (in cents (or local equivalent)) paid for this transaction.
 * @property int $net Net impact to an ExpressPayments balance (in cents (or local equivalent)). A positive value represents incrementing an ExpressPayments balance, and a negative value decrementing an ExpressPayments balance. You can calculate the net impact of a transaction on a balance by <code>amount</code> - <code>fee</code>
 * @property string $reporting_category Learn more about how <a href="https://docs.epayments.network/reports/reporting-categories">reporting categories</a> can help you understand balance transactions from an accounting perspective.
 * @property null|string|\ExpressPayments\ApplicationFee|\ExpressPayments\ApplicationFeeRefund|\ExpressPayments\Charge|\ExpressPayments\CustomerCashBalanceTransaction|\ExpressPayments\Dispute|\ExpressPayments\Issuing\Authorization|\ExpressPayments\Issuing\Dispute|\ExpressPayments\Issuing\Transaction|\ExpressPayments\Payout|\ExpressPayments\Refund|\ExpressPayments\ExpressPaymentsObject|\ExpressPayments\Topup|\ExpressPayments\Transfer|\ExpressPayments\TransferReversal $source This transaction relates to the ExpressPayments object.
 * @property string $status The transaction's net funds status in the ExpressPayments balance, which are either <code>available</code> or <code>pending</code>.
 * @property string $type Transaction type: <code>adjustment</code>, <code>advance</code>, <code>advance_funding</code>, <code>anticipation_repayment</code>, <code>application_fee</code>, <code>application_fee_refund</code>, <code>charge</code>, <code>connect_collection_transfer</code>, <code>contribution</code>, <code>issuing_authorization_hold</code>, <code>issuing_authorization_release</code>, <code>issuing_dispute</code>, <code>issuing_transaction</code>, <code>obligation_inbound</code>, <code>obligation_outbound</code>, <code>obligation_reversal_inbound</code>, <code>obligation_reversal_outbound</code>, <code>obligation_payout</code>, <code>obligation_payout_failure</code>, <code>payment</code>, <code>payment_failure_refund</code>, <code>payment_refund</code>, <code>payment_reversal</code>, <code>payment_unreconciled</code>, <code>payout</code>, <code>payout_cancel</code>, <code>payout_failure</code>, <code>refund</code>, <code>refund_failure</code>, <code>reserve_transaction</code>, <code>reserved_funds</code>, <code>ep_fee</code>, <code>ep_fx_fee</code>, <code>tax_fee</code>, <code>topup</code>, <code>topup_reversal</code>, <code>transfer</code>, <code>transfer_cancel</code>, <code>transfer_failure</code>, or <code>transfer_refund</code>. Learn more about <a href="https://docs.epayments.network/reports/balance-transaction-types">balance transaction types and what they represent</a>. To classify transactions for accounting purposes, consider <code>reporting_category</code> instead.
 */
class BalanceTransaction extends ApiResource
{
    ...
    const TYPE_EP_FEE = 'ep_fee';
    const TYPE_EP_FX_FEE = 'ep_fx_fee';
