 ...
 * <a href="https://docs.epayments.network/api#retrieve_event">individual event</a> or a <a href="https://docs.epayments.network/api#list_events">list of events</a>
 ...
 * webhooks in your
 * <a href="https://dashboard.epayments.network/account/webhooks">account settings</a>. Learn how
 * to [listen for events]
 * (/docs/webhooks) so that your integration can automatically trigger reactions.
 *
 * When using <a href="https://docs.epayments.network/connect">Connect</a>, you can also receive event notifications
 * that occur in connected accounts. For these events, there's an
 * additional <code>account</code> attribute in the received <code>Event</code> object.
 *
 * We only guarantee access to events through the <a href="https://docs.epayments.network/api#retrieve_event">Retrieve Event API</a>
 * for 30 days.
 *
 * This class includes constants for the possible string representations of
 * event types. See https://docs.epayments.network/api#event_types for more details.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string $account The connected account that originates the event.
 * @property null|string $api_version The ExpressPayments API version used to render <code>data</code>. This property is populated only for events on or after October 31, 2014.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \ExpressPayments\ExpressPaymentsObject $data
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $request Information on the API request that triggers the event.
