...
abstract class WebhookSignature
{
    ...
    /**
     * Verifies the signature header sent by ExpressPlatby. Throws an
     * Exception\SignatureVerificationException exception if the verification fails for
     * any reason.
     *
     * @param string $payload the payload sent by ExpressPlatby
     ...
     *
     * The current scheme used by ExpressPlatby ("v1") is HMAC/SHA-256.
     *
