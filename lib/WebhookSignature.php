...
abstract class WebhookSignature
{
    ...
    /**
     * Verifies the signature header sent by ExpressPayments. Throws an
     * Exception\SignatureVerificationException exception if the verification fails for
     * any reason.
     *
     * @param string $payload the payload sent by ExpressPayments
     ...
     *
     * The current scheme used by ExpressPayments ("v1") is HMAC/SHA-256.
     *
