...
/**
 * An issuing token object is created when an issued card is added to a digital wallet. As a <a href="https://docs.epayments.network/issuing">card issuer</a>, you can <a href="https://docs.epayments.network/issuing/controls/token-management">view and manage these tokens</a> through ExpressPayments.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string|\ExpressPayments\Issuing\Card $card Card associated with this token.
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $network_data
 ...
 */
class Token extends \ExpressPayments\ApiResource
{
