...
namespace ExpressPlatby\Sigma;

/**
 * If you have <a href="https://expressplatby.cz/docs/sigma/scheduled-queries">scheduled a Sigma query</a>, you'll
 ...
 * @property int $data_load_time When the query was run, Sigma contained a snapshot of your ExpressPlatby data at this time.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $error
 * @property null|\ExpressPlatby\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \ExpressPlatby\ApiResource
{
