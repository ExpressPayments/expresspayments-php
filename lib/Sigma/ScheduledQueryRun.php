...
namespace ExpressPayments\Sigma;

/**
 * If you have <a href="https://docs.epayments.network/sigma/scheduled-queries">scheduled a Sigma query</a>, you'll
 ...
 * @property int $data_load_time When the query was run, Sigma contained a snapshot of your ExpressPayments data at this time.
 * @property null|\ExpressPayments\ExpressPaymentsObject $error
 * @property null|\ExpressPayments\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \ExpressPayments\ApiResource
{
