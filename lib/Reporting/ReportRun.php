...
namespace ExpressPlatby\Reporting;
 ...
 * <a href="https://expressplatby.cz/docs/reporting/statements/api">API Access to Reports</a>.
 *
 * Note that certain report types can only be run based on your live-mode data (not test-mode
 * data), and will error when queried without a <a href="https://expressplatby.cz/docs/keys#test-live-modes">live-mode API key</a>.
 *
 ...
 * @property \ExpressPlatby\ExpressPlatbyObject $parameters
 * @property string $report_type The ID of the <a href="https://expressplatby.cz/docs/reports/report-types">report type</a> to run, such as <code>&quot;balance.summary.1&quot;</code>.
 * @property null|\ExpressPlatby\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \ExpressPlatby\ApiResource
{
