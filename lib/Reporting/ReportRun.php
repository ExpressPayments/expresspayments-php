...
namespace ExpressPayments\Reporting;
 ...
 * <a href="https://docs.epayments.network/reporting/statements/api">API Access to Reports</a>.
 *
 * Note that certain report types can only be run based on your live-mode data (not test-mode
 * data), and will error when queried without a <a href="https://docs.epayments.network/keys#test-live-modes">live-mode API key</a>.
 *
 ...
 * @property \ExpressPayments\ExpressPaymentsObject $parameters
 * @property string $report_type The ID of the <a href="https://docs.epayments.network/reports/report-types">report type</a> to run, such as <code>&quot;balance.summary.1&quot;</code>.
 * @property null|\ExpressPayments\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \ExpressPayments\ApiResource
{
