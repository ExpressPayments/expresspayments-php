 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $account_holder The account holder for whom accounts are collected in this session.
 * @property \ExpressPlatby\Collection<\ExpressPlatby\FinancialConnections\Account> $accounts The accounts that were collected as part of this Session.
 * @property string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $filters
