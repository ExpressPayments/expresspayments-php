...
/**
 * A discount represents the actual application of a <a href="https://docs.epayments.network/api#coupons">coupon</a> or <a href="https://docs.epayments.network/api#promotion_codes">promotion code</a>.
 * It contains information about when the discount began, when it will end, and what it is applied to.
 *
 * Related guide: <a href="https://docs.epayments.network/billing/subscriptions/discounts">Applying discounts to subscriptions</a>
 *
 ...
 * @property \ExpressPayments\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="https://docs.epayments.network/api#subscriptions">subscriptions</a>, <a href="https://docs.epayments.network/api#invoices">invoices</a>, <a href="https://docs.epayments.network/api/checkout/sessions">checkout sessions</a>, <a href="https://docs.epayments.network/api#quotes">quotes</a>, and more. Coupons do not work with conventional one-off <a href="https://docs.epayments.network/api#create_charge">charges</a> or <a href="https://docs.epayments.network/api/payment_intents">payment intents</a>.
 * @property null|string|\ExpressPayments\Customer $customer The ID of the customer associated with this discount.
 ...
 * @property null|string|\ExpressPayments\PromotionCode $promotion_code The promotion code applied to create this discount.
