...
/**
 * A discount represents the actual application of a <a href="https://expressplatby.cz/docs/api#coupons">coupon</a> or <a href="https://expressplatby.cz/docs/api#promotion_codes">promotion code</a>.
 * It contains information about when the discount began, when it will end, and what it is applied to.
 *
 * Related guide: <a href="https://expressplatby.cz/docs/billing/subscriptions/discounts">Applying discounts to subscriptions</a>
 *
 ...
 * @property \ExpressPlatby\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="https://expressplatby.cz/docs/api#subscriptions">subscriptions</a>, <a href="https://expressplatby.cz/docs/api#invoices">invoices</a>, <a href="https://expressplatby.cz/docs/api/checkout/sessions">checkout sessions</a>, <a href="https://expressplatby.cz/docs/api#quotes">quotes</a>, and more. Coupons do not work with conventional one-off <a href="https://expressplatby.cz/docs/api#create_charge">charges</a> or <a href="https://expressplatby.cz/docs/api/payment_intents">payment intents</a>.
 * @property null|string|\ExpressPlatby\Customer $customer The ID of the customer associated with this discount.
 ...
 * @property null|string|\ExpressPlatby\PromotionCode $promotion_code The promotion code applied to create this discount.
