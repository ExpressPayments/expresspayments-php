 ...
 *
 * Related guide: <a href="https://expressplatby.cz/docs/disputes">Disputes and fraud</a>
 *
 ...
 * @property \ExpressPlatby\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your ExpressPlatby account as a result of this dispute.
 * @property string|\ExpressPlatby\Charge $charge ID of the charge that's disputed.
 ...
 * @property \ExpressPlatby\ExpressPlatbyObject $evidence_details
 * @property bool $is_charge_refundable If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your ExpressPlatby account as a result of this dispute.
 ...
 * @property null|string|\ExpressPlatby\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $payment_method_details
 * @property string $reason Reason given by cardholder for dispute. Possible values are <code>bank_cannot_process</code>, <code>check_returned</code>, <code>credit_not_processed</code>, <code>customer_initiated</code>, <code>debit_not_authorized</code>, <code>duplicate</code>, <code>fraudulent</code>, <code>general</code>, <code>incorrect_account_details</code>, <code>insufficient_funds</code>, <code>product_not_received</code>, <code>product_unacceptable</code>, <code>subscription_canceled</code>, or <code>unrecognized</code>. Learn more about <a href="https://expressplatby.cz/docs/disputes/categories">dispute reasons</a>.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \ExpressPlatby\Dispute the closed dispute
