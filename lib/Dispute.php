 ...
 *
 * Related guide: <a href="https://docs.epayments.network/disputes">Disputes and fraud</a>
 *
 ...
 * @property \ExpressPayments\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your ExpressPayments account as a result of this dispute.
 * @property string|\ExpressPayments\Charge $charge ID of the charge that's disputed.
 ...
 * @property \ExpressPayments\ExpressPaymentsObject $evidence_details
 * @property bool $is_charge_refundable If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your ExpressPayments account as a result of this dispute.
 ...
 * @property null|string|\ExpressPayments\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\ExpressPayments\ExpressPaymentsObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \ExpressPayments\Dispute the closed dispute
