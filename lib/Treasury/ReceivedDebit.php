...
/**
 * ReceivedDebits represent funds pulled from a <a href="https://expressplatby.cz/docs/api#financial_accounts">FinancialAccount</a>. These are not initiated from the FinancialAccount.
 *
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $initiating_payment_method_details
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $reversal_details Details describing when a ReceivedDebit might be reversed.
 ...
 */
class ReceivedDebit extends \ExpressPlatby\ApiResource
{
