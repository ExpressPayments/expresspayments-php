...
/**
 * ReceivedDebits represent funds pulled from a <a href="https://docs.epayments.network/api#financial_accounts">FinancialAccount</a>. These are not initiated from the FinancialAccount.
 *
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $initiating_payment_method_details
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $reversal_details Details describing when a ReceivedDebit might be reversed.
 ...
 */
class ReceivedDebit extends \ExpressPayments\ApiResource
{
