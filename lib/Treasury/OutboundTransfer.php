...
/**
 * Use OutboundTransfers to transfer funds from a <a href="https://expressplatby.cz/docs/api#financial_accounts">FinancialAccount</a> to a PaymentMethod belonging to the same entity. To send funds to a different party, use <a href="https://expressplatby.cz/docs/api#outbound_payments">OutboundPayments</a> instead. You can send funds over ACH rails or through a domestic wire transfer to a user's own external bank account.
 *
 ...
 * @property \ExpressPlatby\ExpressPlatbyObject $destination_payment_method_details
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $returned_details Details about a returned OutboundTransfer. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundTransfer extends \ExpressPlatby\ApiResource
{
     ...
     *
     * @return \ExpressPlatby\Treasury\OutboundTransfer the canceled outbound transfer
