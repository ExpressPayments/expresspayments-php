 ...
 * @property \ExpressPlatby\ExpressPlatbyObject $balance Balance information for the FinancialAccount
 ...
 * @property null|\ExpressPlatby\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. ExpressPlatby or the platform can control Features via the requested field.
 * @property \ExpressPlatby\ExpressPlatbyObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 */
class FinancialAccount extends \ExpressPlatby\ApiResource
{
     ...
     *
     * @return \ExpressPlatby\Treasury\FinancialAccountFeatures the retrieved financial account features
     ...
     * @param null|array|string $opts
     *
     * @return \ExpressPlatby\Treasury\FinancialAccountFeatures the updated financial account features
     * @throws \ExpressPlatby\Exception\ApiErrorException if the request fails
     *
     */
