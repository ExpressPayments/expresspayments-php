...
/**
 * Use <a href="https://expressplatby.cz/docs/treasury/moving-money/financial-accounts/into/inbound-transfers">InboundTransfers</a> to add funds to your <a href="https://expressplatby.cz/docs/api#financial_accounts">FinancialAccount</a> via a PaymentMethod that is owned by you. The funds will be transferred via an ACH debit.
 *
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 */
class InboundTransfer extends \ExpressPlatby\ApiResource
{
     ...
     *
     * @return \ExpressPlatby\Treasury\InboundTransfer the canceled inbound transfer
