...
/**
 * Use OutboundPayments to send funds to another party's external bank account or <a href="https://docs.epayments.network/api#financial_accounts">FinancialAccount</a>. To send money to an account belonging to the same user, use an <a href="https://docs.epayments.network/api#outbound_transfers">OutboundTransfer</a>.
 *
 ...
 * @property null|string $customer ID of the <a href="https://docs.epayments.network/api/customers">customer</a> to whom an OutboundPayment is sent.
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\ExpressPayments\ExpressPaymentsObject $end_user_details Details about the end user.
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundPayment extends \ExpressPayments\ApiResource
{
     ...
     *
     * @return \ExpressPayments\Treasury\OutboundPayment the canceled outbound payment
