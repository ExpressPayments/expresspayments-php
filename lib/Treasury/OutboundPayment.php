...
/**
 * Use OutboundPayments to send funds to another party's external bank account or <a href="https://expressplatby.cz/docs/api#financial_accounts">FinancialAccount</a>. To send money to an account belonging to the same user, use an <a href="https://expressplatby.cz/docs/api#outbound_transfers">OutboundTransfer</a>.
 *
 ...
 * @property null|string $customer ID of the <a href="https://expressplatby.cz/docs/api/customers">customer</a> to whom an OutboundPayment is sent.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $end_user_details Details about the end user.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundPayment extends \ExpressPlatby\ApiResource
{
     ...
     *
     * @return \ExpressPlatby\Treasury\OutboundPayment the canceled outbound payment
