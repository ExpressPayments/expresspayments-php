 ...
 *
 * Related guide: <a href="https://docs.epayments.network/connect/destination-charges#refunding-app-fee">Refunding application fees</a>
 *
 ...
 * @property string|\ExpressPayments\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource
{
    ...
    /**
     * @return string the API URL for this ExpressPayments refund
     */
