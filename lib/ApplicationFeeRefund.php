 ...
 *
 * Related guide: <a href="https://expressplatby.cz/docs/connect/destination-charges#refunding-app-fee">Refunding application fees</a>
 *
 ...
 * @property string|\ExpressPlatby\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource
{
    ...
    /**
     * @return string the API URL for this ExpressPlatby refund
     */
