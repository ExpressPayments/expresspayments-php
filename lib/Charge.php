...
/**
 * The <code>Charge</code> object represents a single attempt to move money into your ExpressPlatby account.
 ...
 * @property int $amount Amount intended to be collected by this payment. A positive integer representing how much to charge in the <a href="https://expressplatby.cz/docs/currencies#zero-decimal">smallest currency unit</a> (e.g., 100 cents to charge $1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is $0.50 US or <a href="https://expressplatby.cz/docs/currencies#minimum-and-maximum-charge-amounts">equivalent in charge currency</a>. The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of $999,999.99).
 ...
 * @property null|string|\ExpressPlatby\ExpressPlatbyObject $application ID of the Connect application that created the charge.
 * @property null|string|\ExpressPlatby\ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://expressplatby.cz/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|int $application_fee_amount The amount of the application fee (if any) requested for the charge. <a href="https://expressplatby.cz/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|string $authorization_code Authorization code on the charge.
 * @property null|string|\ExpressPlatby\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property null|string|\ExpressPlatby\Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property bool $disputed Whether the charge has been disputed.
 * @property null|string|\ExpressPlatby\BalanceTransaction $failure_balance_transaction ID of the balance transaction that describes the reversal of the balance on your account due to payment failure.
 * @property null|string $failure_code Error code explaining reason for charge failure if available (see <a href="https://expressplatby.cz/docs/error-codes">the errors section</a> for a list of codes).
 * @property null|string $failure_message Message to user further explaining reason for charge failure if available.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $fraud_details Information on fraud assessments for the charge.
 * @property null|string|\ExpressPlatby\Invoice $invoice ID of the invoice this charge is for if one exists.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $level3
 ...
 * @property null|string|\ExpressPlatby\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://expressplatby.cz/docs/connect/separate-charges-and-transfers">Connect documentation</a> for details.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $outcome Details about whether the payment was accepted, and why. See <a href="https://expressplatby.cz/docs/declines">understanding declines</a> for details.
 * @property bool $paid <code>true</code> if the charge succeeded, or was successfully authorized for later capture.
 * @property null|string|\ExpressPlatby\PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 * @property null|string $payment_method ID of the payment method used in this charge.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property null|\ExpressPlatby\Collection<\ExpressPlatby\Refund> $refunds A list of refunds that have been applied to the charge.
 * @property null|string|\ExpressPlatby\Review $review ID of the review associated with this charge if one exists.
 * @property null|\ExpressPlatby\ExpressPlatbyObject $shipping Shipping information for the charge.
 * @property null|\ExpressPlatby\Account|\ExpressPlatby\BankAccount|\ExpressPlatby\Card|\ExpressPlatby\Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|\ExpressPlatby\Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another ExpressPlatby account. <a href="https://expressplatby.cz/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property null|string|\ExpressPlatby\Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
 * @property null|\ExpressPlatby\ExpressPlatbyObject $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://expressplatby.cz/docs/connect/destination-charges">See the Connect documentation</a> for details.
 * @property null|string $transfer_group A string that identifies this transaction as part of a group. See the <a href="https://expressplatby.cz/docs/connect/separate-charges-and-transfers#transfer-options">Connect documentation</a> for details.
 */
class Charge extends ApiResource
{
     ...
     * These strings are applicable to the decline_code property of the \ExpressPlatby\Exception\CardException exception.
     *
     * @see https://expressplatby.cz/docs/declines/codes
     */
     ...
     *
     * @return \ExpressPlatby\Charge the captured charge
     ...
     * @param null|array|string $opts
     *
     * @return \ExpressPlatby\SearchResult<\ExpressPlatby\Charge> the charge search results
     *@throws \ExpressPlatby\Exception\ApiErrorException if the request fails
     *
     */
