...
/**
 * The <code>Charge</code> object represents a single attempt to move money into your ExpressPayments account.
 ...
 * @property null|string|\ExpressPayments\ExpressPaymentsObject $application ID of the Connect application that created the charge.
 * @property null|string|\ExpressPayments\ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://docs.epayments.network/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|int $application_fee_amount The amount of the application fee (if any) requested for the charge. <a href="https://docs.epayments.network/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|string $authorization_code Authorization code on the charge.
 * @property null|string|\ExpressPayments\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property null|string|\ExpressPayments\Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property bool $disputed Whether the charge has been disputed.
 * @property null|string|\ExpressPayments\BalanceTransaction $failure_balance_transaction ID of the balance transaction that describes the reversal of the balance on your account due to payment failure.
 * @property null|string $failure_code Error code explaining reason for charge failure if available (see <a href="https://docs.epayments.network/error-codes">the errors section</a> for a list of codes).
 * @property null|string $failure_message Message to user further explaining reason for charge failure if available.
 * @property null|\ExpressPayments\ExpressPaymentsObject $fraud_details Information on fraud assessments for the charge.
 * @property null|string|\ExpressPayments\Invoice $invoice ID of the invoice this charge is for if one exists.
 * @property null|\ExpressPayments\ExpressPaymentsObject $level3
 ...
 * @property null|string|\ExpressPayments\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://docs.epayments.network/connect/separate-charges-and-transfers">Connect documentation</a> for details.
 * @property null|\ExpressPayments\ExpressPaymentsObject $outcome Details about whether the payment was accepted, and why. See <a href="https://docs.epayments.network/declines">understanding declines</a> for details.
 * @property bool $paid <code>true</code> if the charge succeeded, or was successfully authorized for later capture.
 * @property null|string|\ExpressPayments\PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 * @property null|string $payment_method ID of the payment method used in this charge.
 * @property null|\ExpressPayments\ExpressPaymentsObject $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property null|\ExpressPayments\Collection<\ExpressPayments\Refund> $refunds A list of refunds that have been applied to the charge.
 * @property null|string|\ExpressPayments\Review $review ID of the review associated with this charge if one exists.
 * @property null|\ExpressPayments\ExpressPaymentsObject $shipping Shipping information for the charge.
 * @property null|\ExpressPayments\Account|\ExpressPayments\BankAccount|\ExpressPayments\Card|\ExpressPayments\Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|\ExpressPayments\Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another ExpressPayments account. <a href="https://docs.epayments.network/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property null|string|\ExpressPayments\Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
 * @property null|\ExpressPayments\ExpressPaymentsObject $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://docs.epayments.network/connect/destination-charges">See the Connect documentation</a> for details.
...
class Charge extends ApiResource
{
     ...
     * These strings are applicable to the decline_code property of the \ExpressPayments\Exception\CardException exception.
     *
     * @see https://docs.epayments.network/declines/codes
     */
     ...
     *
     * @return \ExpressPayments\Charge the captured charge
     ...
     * @param null|array|string $opts
     *
     * @return \ExpressPayments\SearchResult<\ExpressPayments\Charge> the charge search results
     * @throws \ExpressPayments\Exception\ApiErrorException if the request fails
     *
     */
