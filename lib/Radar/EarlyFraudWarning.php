 ...
 *
 * Related guide: <a href="https://docs.epayments.network/disputes/measuring#early-fraud-warnings">Early fraud warnings</a>
 *
 ...
 * @property string|\ExpressPayments\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\ExpressPayments\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \ExpressPayments\ApiResource
{
