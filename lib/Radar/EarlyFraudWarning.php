 ...
 *
 * Related guide: <a href="https://expressplatby.cz/docs/disputes/measuring#early-fraud-warnings">Early fraud warnings</a>
 *
 ...
 * @property string|\ExpressPlatby\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\ExpressPlatby\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \ExpressPlatby\ApiResource
{
