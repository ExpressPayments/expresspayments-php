 ...
 * @property null|string $product The ID of an existing <a href="https://docs.epayments.network/api/products/object">Product</a>.
 ...
 * @property string $tax_code The <a href="https://docs.epayments.network/tax/tax-categories">tax code</a> ID used for this resource.
 * @property string $type If <code>reversal</code>, this line item reverses an earlier transaction.
 */
class TransactionLineItem extends \ExpressPayments\ApiResource
{
