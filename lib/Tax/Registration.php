...
/**
 * A Tax <code>Registration</code> lets us know that your business is registered to collect tax on payments within a region, enabling you to <a href="https://expressplatby.cz/docs/tax">automatically collect tax</a>.
 *
 * ExpressPlatby doesn't register on your behalf with the relevant authorities when you create a Tax <code>Registration</code> object. For more information on how to register to collect tax, see <a href="https://expressplatby.cz/docs/tax/registering">our guide</a>.
 *
 * Related guide: <a href="https://expressplatby.cz/docs/tax/registrations-api">Using the Registrations API</a>
 *
 ...
 * @property \ExpressPlatby\ExpressPlatbyObject $country_options
 ...
 */
class Registration extends \ExpressPlatby\ApiResource
{
