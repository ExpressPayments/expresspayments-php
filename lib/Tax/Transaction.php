 ...
 *
 * Related guide: <a href="https://docs.epayments.network/tax/custom#tax-transaction">Calculate tax in your custom payment flow</a>
 *
 ...
 * @property null|\ExpressPayments\Collection<\ExpressPayments\Tax\TransactionLineItem> $line_items The tax collected or refunded, by line item.
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $reversal If <code>type=reversal</code>, contains information about what was reversed.
 * @property null|\ExpressPayments\ExpressPaymentsObject $shipping_cost The shipping cost details for the transaction.
...
class Transaction extends \ExpressPayments\ApiResource
{
     ...
     *
     * @return \ExpressPayments\Tax\Transaction the created transaction
     ...
     * @param null|array|string $opts
     *
     * @return \ExpressPayments\Collection<\ExpressPayments\Tax\TransactionLineItem> list of transaction line items
     * @throws \ExpressPayments\Exception\ApiErrorException if the request fails
     *
     */
