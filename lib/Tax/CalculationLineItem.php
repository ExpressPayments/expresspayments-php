 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject[] $tax_breakdown Detailed account of taxes relevant to this line item.
 * @property string $tax_code The <a href="https://docs.epayments.network/tax/tax-categories">tax code</a> ID used for this resource.
 */
class CalculationLineItem extends \ExpressPayments\ApiResource
{
