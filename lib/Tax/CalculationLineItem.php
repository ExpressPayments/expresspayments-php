 ...
 * @property null|string $product The ID of an existing <a href="https://expressplatby.cz/docs/api/products/object">Product</a>.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject[] $tax_breakdown Detailed account of taxes relevant to this line item.
 * @property string $tax_code The <a href="https://expressplatby.cz/docs/tax/tax-categories">tax code</a> ID used for this resource.
 */
class CalculationLineItem extends \ExpressPlatby\ApiResource
{
