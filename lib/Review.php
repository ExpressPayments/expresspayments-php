 ...
 * <a href="https://expressplatby.cz/docs/radar/reviews">here</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string $billing_zip The ZIP or postal code of the card used, if applicable.
 * @property null|string|\ExpressPlatby\Charge $charge The charge associated with this review.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property null|string|\ExpressPlatby\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $session Information related to the browsing session of the user who initiated the payment.
 */
class Review extends ApiResource
{
     ...
     *
     * @see https://expressplatby.cz/docs/api/radar/reviews/object
     */
     ...
     *
     * @return \ExpressPlatby\Review the approved review
