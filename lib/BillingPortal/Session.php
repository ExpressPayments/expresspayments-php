...
namespace ExpressPayments\BillingPortal;
 ...
 * and billing details.
 *
 * Learn more in the <a href="https://docs.epayments.network/billing/subscriptions/integrating-customer-portal">integration guide</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string|\ExpressPayments\BillingPortal\Configuration $configuration The configuration used by this session, describing the features available.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $customer The ID of the customer for this session.
 * @property null|\ExpressPayments\ExpressPaymentsObject $flow Information about a specific flow for the customer to go through. See the <a href="https://docs.epayments.network/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
