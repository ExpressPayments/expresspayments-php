 ...
 * applied to a purchase. For more information, see <a href="https://expressplatby.cz/docs/payments/during-payment/charge-shipping">Charge for shipping</a>.
 *
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $delivery_estimate The estimated range for how long shipping will take, meant to be displayable to the customer. This will appear on CheckoutSessions.
 ...
 * @property null|\ExpressPlatby\ExpressPlatbyObject $fixed_amount
 ...
 * @property null|string|\ExpressPlatby\TaxCode $tax_code A <a href="https://expressplatby.cz/docs/tax/tax-categories">tax code</a> ID. The Shipping tax code is <code>txcd_92010001</code>.
