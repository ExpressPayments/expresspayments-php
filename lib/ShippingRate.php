 ...
 * applied to a purchase. For more information, see <a href="https://docs.epayments.network/payments/during-payment/charge-shipping">Charge for shipping</a>.
 *
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $delivery_estimate The estimated range for how long shipping will take, meant to be displayable to the customer. This will appear on CheckoutSessions.
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $fixed_amount
 ...
 * @property null|string|\ExpressPayments\TaxCode $tax_code A <a href="https://docs.epayments.network/tax/tax-categories">tax code</a> ID. The Shipping tax code is <code>txcd_92010001</code>.
