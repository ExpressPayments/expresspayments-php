...
/**
 * You can now model subscriptions more flexibly using the <a href="https://docs.epayments.network/api#prices">Prices API</a>. It replaces the Plans API and is backwards compatible to simplify your migration.
 *
 * Plans define the base price, currency, and billing cycle for recurring purchases of products.
 * <a href="https://docs.epayments.network/api#products">Products</a> help you track inventory or provisioning, and plans help you track pricing. Different physical goods or levels of service should be represented by products, and pricing options should be represented by plans. This approach lets you change prices without having to change your provisioning scheme.
 *
 * For example, you might have a single &quot;gold&quot; product that has plans for $10/month, $100/year, €9/month, and €90/year.
 *
 * Related guides: <a href="https://docs.epayments.network/billing/subscriptions/set-up-subscription">Set up a subscription</a> and more about <a href="https://docs.epayments.network/products-prices/overview">products and prices</a>.
 *
 ...
 * @property null|string|\ExpressPayments\Product $product The product whose pricing this plan determines.
 ...
 * @property null|\ExpressPayments\ExpressPaymentsObject $transform_usage Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
 * @property null|int $trial_period_days Default number of trial days when subscribing a customer to this plan using <a href="https://docs.epayments.network/api#create_subscription-trial_from_plan"><code>trial_from_plan=true</code></a>.
