...
/**
 * Each customer has a <a href="https://expressplatby.cz/docs/api/customers/object#customer_object-balance">Balance</a> value,
 * which denotes a debit or credit that's automatically applied to their next invoice upon finalization.
 * You may modify the value directly by using the <a href="https://expressplatby.cz/docs/api/customers/update">update customer API</a>,
 ...
 *
 * Related guide: <a href="https://expressplatby.cz/docs/billing/customer/balance">Customer balance</a>
 *
 ...
 * @property null|string|\ExpressPlatby\CreditNote $credit_note The ID of the credit note (if any) related to the transaction.
 ...
 * @property string|\ExpressPlatby\Customer $customer The ID of the customer the transaction belongs to.
 ...
 * @property null|string|\ExpressPlatby\Invoice $invoice The ID of the invoice (if any) related to the transaction.
