...
/**
 * Each customer has a <a href="https://docs.epayments.network/api/customers/object#customer_object-balance">Balance</a> value,
 * which denotes a debit or credit that's automatically applied to their next invoice upon finalization.
 * You may modify the value directly by using the <a href="https://docs.epayments.network/api/customers/update">update customer API</a>,
 ...
 *
 * Related guide: <a href="https://docs.epayments.network/billing/customer/balance">Customer balance</a>
 *
 ...
 * @property null|string|CreditNote $credit_note The ID of the credit note (if any) related to the transaction.
 ...
 * @property string|Customer $customer The ID of the customer the transaction belongs to.
 ...
 * @property null|string|Invoice $invoice The ID of the invoice (if any) related to the transaction.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|ExpressPaymentsObject $metadata Set of <a href="https://docs.epayments.network/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 * @property string $type Transaction type: <code>adjustment</code>, <code>applied_to_invoice</code>, <code>credit_note</code>, <code>initial</code>, <code>invoice_overpaid</code>, <code>invoice_too_large</code>, <code>invoice_too_small</code>, <code>unspent_receiver_credit</code>, or <code>unapplied_from_invoice</code>. See the <a href="https://docs.epayments.network/billing/customer/balance#types">Customer Balance page</a> to learn more about transaction types.
 */
